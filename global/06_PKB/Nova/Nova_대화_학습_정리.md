...
### & c:\Users\psh93\OneDrive\Desktop\Workspace\projects\sv_lakehouse\.venv\Scripts\
**날짜:** 2026-04-12 | **파일:** 98492c00-8e6e-49c6-99dd-624baec7bed7.jsonl

**맥락 요약:** & c:\Users\psh93\OneDrive\Desktop\Workspace\projects\sv_lakehouse\.venv\Scripts\Activate.ps1 You've hit your limit · resets 3pm (Asia/Seoul)
...
### & c:\Users\psh93\OneDrive\Desktop\Workspace\projects\sv_lakehouse\.venv\Scripts\
**날짜:** 2026-04-12 | **파일:** 0d4b1a5b-6123-4c74-8314-240116ad6505.jsonl

**맥락 요약:** & c:\Users\psh93\OneDrive\Desktop\Workspace\projects\sv_lakehouse\.venv\Scripts\Activate.ps1 bash 셸에서는 PowerShell `.ps1` 스크립트를 직접 실행할 수 없습니다. bash용 `activate` 스크립트를 사용해야 합니다. 활성화는 됐지만 `VIRTUAL_ENV` 경로...
...
### & c:\Users\psh93\OneDrive\Desktop\Workspace\projects\sv_lakehouse\.venv\Scripts\
**날짜:** 2026-04-13 | **파일:** aef3ed9f-90d1-4ad6-99a1-8c12300d0bca.jsonl

**맥락 요약:** & c:\Users\psh93\OneDrive\Desktop\Workspace\projects\sv_lakehouse\.venv\Scripts\Activate.ps1 PowerShell 활성화 스크립트는 bash 환경에서 동작하지 않습니다. bash에서는 아래 명령을 사용하세요:  ```bash source projects/sv_lakehouse/.venv...

**대화 길이:** 총 4개 메시지

---

### 파이프라인 테스트 하고, slack으로 알림이 가는지 확인해줘
**날짜:** 2026-04-14 | **파일:** a4601a22-29be-45cd-a819-710fedba0be1.jsonl | **메시지:** 6개

**배운 것:** 파이프라인 테스트 하고, slack으로 알림이 가는지 확인해줘 어떤 파이프라인을 테스트할지 먼저 파악하겠습니다. orchestrator가 `nova_helper/.env`를 로드하므로 SLACK_BOT_TOKEN이 사용 가능합니다. PKB 파이프라인 dry-run과 Slack 알림을 순서대로 테스트하겠습니다. PKB RAG 검색까지 정상. 이제 Slack...
